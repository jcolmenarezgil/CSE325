...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString, int? releaseYear)
        {
            ...
            {
                moviesQuery = moviesQuery.Where(x => x.ReleaseDate.Year >= releaseYear.Value);
            }
            ...
            ViewData["CurrentYear"] = releaseYear;
        ...
        // Método auxiliar necesario para verificar si la película existe
